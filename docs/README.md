...
- `docs/framework/README.md` - 通用图谱构建框架
...
- 📖 [技术流程文档](./architecture/technical_workflow.md) | 💬 [对话记录系统](./architecture/conversation_history_system.md) | 🧠 [上下文增强系统](./architecture/context_enhancement.md) | 🎯 [通用图谱构建框架](./framework/README.md) | 📦 [项目根目录](../)
